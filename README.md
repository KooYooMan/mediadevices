...
<p align="center">
  ...
  <a href="https://github.com/qnkhuat/mediadevices/actions"><img src="https://github.com/qnkhuat/mediadevices/workflows/CI/badge.svg?branch=master" alt="Build status"></a> 
  <a href="https://pkg.go.dev/github.com/qnkhuat/mediadevices"><img src="https://godoc.org/github.com/qnkhuat/mediadevices?status.svg" alt="GoDoc"></a>
...
`go get -u github.com/qnkhuat/mediadevices`
...
import (
	...
	_ "github.com/qnkhuat/mediadevices/pkg/driver/camera" 
	// Note: If you don't have a camera or your adapters are not supported,
	//       you can always swap your adapters with our dummy adapters below.
	// _ "github.com/qnkhuat/mediadevices/pkg/driver/videotest"
)
...
import (
	"github.com/qnkhuat/mediadevices"
	"github.com/qnkhuat/mediadevices/pkg/codec/x264"      // This is required to use H264 video encoder
...
* Package: [github.com/qnkhuat/mediadevices/pkg/codec/x264](https://pkg.go.dev/github.com/qnkhuat/mediadevices/pkg/codec/x264)
* Installation:
...
* Package: [github.com/qnkhuat/mediadevices/pkg/codec/mmal](https://pkg.go.dev/github.com/qnkhuat/mediadevices/pkg/codec/mmal)
...
* Package: [github.com/qnkhuat/mediadevices/pkg/codec/openh264](https://pkg.go.dev/github.com/qnkhuat/mediadevices/pkg/codec/openh264)
...
* Package: [github.com/qnkhuat/mediadevices/pkg/codec/vpx](https://pkg.go.dev/github.com/qnkhuat/mediadevices/pkg/codec/vpx)
* Installation:
...
* Package: [github.com/qnkhuat/mediadevices/pkg/codec/vaapi](https://pkg.go.dev/github.com/qnkhuat/mediadevices/pkg/codec/vaapi)
* Installation:
...
* Package: [github.com/qnkhuat/mediadevices/pkg/codec/opus](https://pkg.go.dev/github.com/qnkhuat/mediadevices/pkg/codec/opus)
* Installation:
...
* Driver was not imported as a side effect in your program, e.g. `import _ github.com/qnkhuat/mediadevices/pkg/driver/camera`
